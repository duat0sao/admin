...
if (isset($_POST['update_user'])){
  ...
  $sql = "UPDATE tbl_user SET pwd='$mk1', email='$email', fname='$fname',  lname='$lname', age='$age' WHERE id='$id'";
    ...
    <div>
        ...
        <div class="mb-3">
            ...
            <label class="form-message"></label>
                ...
                <br><h4>Age</h4>
                <input style="width:100; font-size: 20px;" type="number" class="form-contr" name="age" value="<?php echo $row2['age'];?>">
                
                
                <br><h4>Mật khẩu</h4>
                <input style="width:100; font-size: 20px;" type="password" class="form-contr" name="mk" value="<?php echo $row2['pwd'];?>">
