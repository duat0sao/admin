...
if (isset($_POST['btnSignUp'])) {
    ...
    if (mysqli_num_rows($result01) > 0) {
        ...
        //$sql02 = "INSERT INTO tbl_user(fname,lname,age,email,pwd) VALUES ('$fname','$lname','$age','$email','$pwd')";
        ...
        if ($stmt = mysqli_prepare($conn, $sql02)) {
            ...
            $param_age = $age;
            $param_email = $email;
            $param_pwd = $pwd; //password_hash($pwd, PASSWORD_DEFAULT); // Creates a password hash
